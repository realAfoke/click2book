...
class AppointmentSerializer(serializers.ModelSerializer):
    class Meta():
        model=Consultants
        fields=['id','purpose','status','consult_time','owner']
...
class BookingSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        try:
            ...
            appointment_data={'purpose':validated_data['purpose'],'consult_time':validated_data['consult_time'],'status':'booked','owner':client}
            ...
            return {'email':client.email,'name':client.name,'phone_number':client.phone_number,'purpose':appointment.purpose,'consult_time':appointment.consult_time}
